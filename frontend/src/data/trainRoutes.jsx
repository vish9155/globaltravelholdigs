export let trainroutes = [
  ...
  { "id": 4, "category": "domestic", "from": { "code": "ORD", "city": "Chicago" }, "to": { "code": "DEN", "city": "Denver" }, "departureDate": "2026-05-16", "returnDate": "2026-05-20", "tripType": "RoundTrip", "price": 145.60, "currency": "USD" },
  { "id": 5, "category": "domestic", "from": { "code": "LAS", "city": "Las Vegas" }, "to": { "code": "LAX", "city": "Los Angeles" }, "departureDate": "2026-05-18", "returnDate": "2026-05-22", "tripType": "RoundTrip", "price": 89.99, "currency": "USD" },
  { "id": 6, "category": "domestic", "from": { "code": "SEA", "city": "Seattle" }, "to": { "code": "PHX", "city": "Phoenix" }, "departureDate": "2026-05-20", "returnDate": "2026-05-24", "tripType": "RoundTrip", "price": 160.30, "currency": "USD" },
...
>>>>>>> d440d1e0a216ffdab56b88f8a6cc7268c5c2d00b
  ...
  { "id": 13, "category": "international", "from": { "code": "SFO", "city": "San Francisco" }, "to": { "code": "SIN", "city": "Singapore" }, "departureDate": "2026-05-14", "returnDate": "2026-05-24", "tripType": "RoundTrip", "price": 910.20, "currency": "USD" },
  { "id": 14, "category": "international", "from": { "code": "ORD", "city": "Chicago" }, "to": { "code": "CDG", "city": "Paris" }, "departureDate": "2026-05-16", "returnDate": "2026-05-26", "tripType": "RoundTrip", "price": 700.60, "currency": "USD" },
  { "id": 15, "category": "international", "from": { "code": "MIA", "city": "Miami" }, "to": { "code": "GRU", "city": "São Paulo" }, "departureDate": "2026-05-18", "returnDate": "2026-05-28", "tripType": "RoundTrip", "price": 680.90, "currency": "USD" },
  { "id": 16, "category": "international", "from": { "code": "DFW", "city": "Dallas" }, "to": { "code": "MEX", "city": "Mexico City" }, "departureDate": "2026-05-20", "returnDate": "2026-05-27", "tripType": "RoundTrip", "price": 350.25, "currency": "USD" },
...
>>>>>>> d440d1e0a216ffdab56b88f8a6cc7268c5c2d00b
  ...
  { "id": 23, "category": "popular", "from": { "code": "LAX", "city": "Los Angeles" }, "to": { "code": "HND", "city": "Tokyo" }, "departureDate": "2026-06-05", "returnDate": "2026-06-15", "tripType": "RoundTrip", "price": 850.00, "currency": "USD" },
  { "id": 24, "category": "popular", "from": { "code": "ATL", "city": "Atlanta" }, "to": { "code": "MCO", "city": "Orlando" }, "departureDate": "2026-06-07", "returnDate": "2026-06-11", "tripType": "RoundTrip", "price": 135.00, "currency": "USD" },
  { "id": 25, "category": "popular", "from": { "code": "LAX", "city": "Los Angeles" }, "to": { "code": "LAS", "city": "Las Vegas" }, "departureDate": "2026-06-09", "returnDate": "2026-06-12", "tripType": "RoundTrip", "price": 95.00, "currency": "USD" },
  { "id": 26, "category": "popular", "from": { "code": "ORD", "city": "Chicago" }, "to": { "code": "LHR", "city": "London" }, "departureDate": "2026-06-11", "returnDate": "2026-06-20", "tripType": "RoundTrip", "price": 720.00, "currency": "USD" },
