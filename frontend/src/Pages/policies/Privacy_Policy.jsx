...
export default function PrivacyPolicy() {
  return (
    <section className="bg-gradient-to-b from-green-50 via-white/40 to-green-50 min-h-screen py-10 sm:py-14">
      <div className="max-w-5xl mx-auto px-4">
        {/* Hero */}
        <div className="relative overflow-hidden rounded-3xl border border-green-200 bg-white shadow-xl">
          <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 via-transparent to-gray-500/10"></div>

          <div className="relative px-6 py-10 sm:px-10 sm:py-14">
            <p className="inline-block rounded-full bg-green-100 text-green-800 text-xs sm:text-sm font-semibold px-4 py-1">
              Global Travel Legal
            </p>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="rounded-2xl bg-white border border-green-200 shadow-sm p-6">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-green-500 to-gray-400 text-white shadow-lg p-6">
