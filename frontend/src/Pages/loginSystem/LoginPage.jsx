...
export default function LoginPage() {
    ...
    let handleForm = async (e) => {
        try {
            e.preventDefault();
            setLoading(true)
            let resp = await fetch("https://www.globaltravel-holdings.com/user/login", {
                ...
                <form onSubmit={handleForm}  >
                    ...
                    <div className="relative mb-2">
                        <input
                            ...
                            onChange={formInput}
                            className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none pr-10 text-sm"
                        />
                        <span
                    ...
                    <div className="flex items-center justify-between ">
                        < div className="text-right mb-4">
                            <NavLink to={'/email-otp'} className="text-xs text-indigo-600 cursor-pointer hover:underline">
                                Login with email?
                            </NavLink>
                        </div>
                        <div className="text-right mb-4">
