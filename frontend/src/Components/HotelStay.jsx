    ...
    <div className='max-w-7xl mx-auto px-6'>
        ...
        <div className='mb-12 border-l-4 border-orange-500 pl-6'>
            <h2 className='text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3'>
                <HotelIcon size={40} className='text-blue-600' /> 
                Luxury <span className="text-orange-500">Hotel</span> Stays
            </h2>
                    ...
                    >
                        ...
                        <div className="relative h-[420px] w-full overflow-hidden">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                                ...
                                <NavLink
                                    to="/"
                                    className="inline-flex items-center gap-2 bg-orange-500  text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 transform scale-90 group-hover:scale-100 origin-left"
                                >
                                    Explore More
                                    <ArrowRight size={18} />
                                </NavLink>
                            ...
                            <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md text-white text-[10px] uppercase tracking-widest px-3 py-1 rounded-full border border-white/30">
                                Luxury Stay
                            </div>
                        </div>
                    </SwiperSlide>
