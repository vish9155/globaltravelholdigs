...
export default function ProfileUpdate() {
    ...
    let uploadImage = async () => {
        ...
        let resp = await fetch("http://localhost:5000/user/update-image/"+id, {
            method: "PUT",
            credentials: "include",
            body: formData 
        });
    ...
    let formHandle = async (e) => {
        try {
            ...
            let resp = await fetch("http://localhost:5000/user/profile/update/" + id, {
                method: "PUT",
                credentials: "include",
                headers: {
    ...
    let fetchdata = async () => {
        try {
            let resp = await fetch("http://localhost:5000/user/profile/" + id, {
